<x-base-layout>
    ...
    <div class="bg-white border-b border-gray-100 py-8">
        <div
            class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
    ...
    <section class="py-10 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            @if (!empty($files))
                ...
                <div class="masonry-thumbs grid-container grid-4 has-init-isotope" data-big="4"
